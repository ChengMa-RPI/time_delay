...
def compare_xs_multi_group_degree_weighted_decouple(dynamics, network_type, N, d, beta, betaeffect, group_num, seed):
    """TODO: Docstring for compare_xs_multi_group.
    ...
    """
    des = '../data/' + dynamics + '/' + network_type + '/xs_group_decouple/'
    if betaeffect:
        des_file = des + f'N={N}_d=' + str(d) + '_beta=' + str(beta) + f'_group_num={group_num}_seed={seed}.csv'
    else:
        des_file = des + f'N={N}_d=' + str(d) + '_wt=' + str(beta) + f'_group_num={group_num}_seed={seed}.csv'
    ...
    xs_multi_degree = data[:, 2]
    xs_multi_group = data[:, 3]
    plt.plot(xs_multi_degree, xs_multi_group , 'o')
    x = [np.min(np.hstack((xs_multi_degree, xs_multi_group))), np.max(np.hstack((xs_multi_degree, xs_multi_group)))]
    plt.plot(x, x, '--', color='#fc8d62')
    plt.xticks(fontsize=ticksize)
    plt.yticks(fontsize=ticksize)
...
def xs_multi_degree_weighted_decouple_group_num(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list):
    """TODO: Docstring for compare_xs_multi_group.
...
def xs_multi_degree_weighted_decouple_group_num_knn(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, r):
    """TODO: Docstring for compare_xs_multi_group.
...
def compare_xs_multi_group_decouple_movement(dynamics, network_type, N, d, beta, betaeffect, group_num, seed, r):
    """TODO: Docstring for compare_xs_multi_group.
...
def xs_multi_group_decouple_movement(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, r, space):
    """TODO: Docstring for compare_xs_multi_group.
...
for d in d_list:
    for group_num in group_num_list:
        ...
        #xs_multi_degree, xs_multi_group = compare_xs_multi_group_degree_weighted(dynamics, network_type, N, d, beta, betaeffect, group_num, seed)
        #xs_multi_degree, xs_multi_group = compare_xs_multi_group_degree_weighted_decouple(dynamics, network_type, N, d, beta, betaeffect, group_num, seed)
        #compare_xs_multi_group_decouple_movement(dynamics, network_type, N, d, beta, betaeffect, group_num, seed, 2)
        pass
#plt.show()
...
for d in d_list:
    ...
    #xs_multi_degree_weighted_decouple_group_num(dynamics, network_type, N, d, beta, betaeffect, group_num_list, seed_list)
    #xs_multi_degree(dynamics, network_type, N, d, beta, betaeffect, seed)
    pass

r_list = [0, 0.2, 0.4, 0.6, 0.8, 1]
r_list = [0.6, 0.7, 0.8, 0.9, 1]
for dynamics in ['mutual']:
    network_type = 'ER'
    d_list = [4000]
    network_type = 'RGG'
    d_list = [0.04]
    #xs_multi_degree_weighted_decouple_group_num(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list)
    #xs_multi_degree_weighted_decouple_group_num_knn(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, r)
    pass
    ...
    d_list = [4000]
    for r in r_list:
        #xs_multi_degree_weighted_decouple_group_num_knn(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, 0)
        #xs_multi_group_decouple_movement(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, r)
        pass
...
network_type = 'RGG'
d_list_list = [[0.04], [0.05], [0.07]]
seed_list = seed_ER

network_type = 'SF'
d_list_list = [[[3.8, 999, 5]], [[2.1, 999, 2]], [[2.5, 999, 3]], [[3, 999, 4]]]
seed_list = seed_SF

network_type = 'ER'
d_list_list = [[2000], [4000], [8000]]
seed_list = seed_ER
...
for d_list in d_list_list:
    for space in ['linear']:
        for r in r_list:
            pass
            #xs_multi_group_decouple_movement(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, r, space)
        #xs_multi_group_decouple_space(dynamics, network_type, N, d_list, beta, betaeffect, group_num_list, seed_list, space)
        #plt.savefig('../report/report070721/' + dynamics + '_' + network_type + '_' + str(d_list[0]) + space + f'_k=2_movement.png')
        #plt.close('all')
