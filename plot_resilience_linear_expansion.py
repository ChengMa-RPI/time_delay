...
def xs_resilience_degree_partition(network_type, N, d, seed, dynamics, number_groups, xaxis, space):
    ...
    save_des = '../report/report100621/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_degree_' + space + f'_number_groups={number_groups}_' + xaxis + '.png'
    data_plot_resilience_function(des_file, xaxis, save_des)
    return None

def xs_resilience_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, number_groups, xaxis, space):
    """TODO: Docstring for xs_resilience.
    ...
    save_des = '../report/report100621/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_linear_expansion_degree_' + space + f'_number_groups={number_groups}_' + xaxis + '.png'
    data_plot_resilience_function(des_file, xaxis, save_des)
    return None
...
def xs_resilience_kcore_linear_expansion(network_type, N, d, seed, dynamics, xaxis, regroup):
    """TODO: Docstring for xs_resilience.
    ...
    if regroup == 'None':
        ...
        des_file = des + f'N={N}_d=' + str(d) + f'_seed={seed}.csv'
        save_des = '../report/report100621/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_linear_expansion_kcore_' + xaxis + '.png'
    else:
        des = '../data/' + dynamics + '/' + network_type + f'/xs_kcore_regroup/'
        des_file = des + f'N={N}_d=' + str(d) + f'_seed={seed}_regroup={regroup}.csv'
        save_des = '../report/report091521/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_kcore_regroup={regroup}_' + xaxis + '.png'
...
def xs_resilience_KNN_kcore_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, xaxis, regroup_criteria, space, degree_interval):
    """TODO: Docstring for xs_resilience_KNN_kcore_degree_parallel_partition.
    ...
    if regroup_criteria == 'None':
        ...
        des_file = des + f'N={N}_d=' + str(d) + f'_seed={seed}.csv'
        save_des = '../report/report100621/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_linear_expansion_KNN_kcore_' + space + f'={degree_interval}_' + xaxis + '.png'
    else:
        des = '../data/' + dynamics + '/' + network_type + f'/xs_KNN_kcore_degree_regroup_criteria_' + space + f'={degree_interval}/'
        des_file = des + f'N={N}_d=' + str(d) + f'_seed={seed}_regroup_criteria={regroup_criteria}.csv'
        save_des = '../report/report091521/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_KNN_kcore_' + space + f'={degree_interval}_regroup_criteria={regroup_criteria}_' + xaxis + '.png'
...
def xs_resilience_kcore_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, xaxis, space, degree_interval):
    """TODO: Docstring for xs_resilience_KNN_kcore_degree_parallel_partition.
    ...
    des_file = des + f'N={N}_d=' + str(d) + f'_seed={seed}.csv'
    save_des = '../report/report100621/' + dynamics + '_' + network_type + f'_N_={N}_d={d}_seed={seed}_linear_expansion_kcore_degree_' + space + f'={degree_interval}_' + xaxis + '.png'
    data_plot_resilience_function(des_file, xaxis, save_des)
    return None
...
number_groups_list_list = [[1, 5], [1, 5], [1, 3], [1, 2]]
...
d_list = [[2.5, 999, 3]]
seed_list = [[0, 0]]
degree_interval_list = [1.5]
space_list = ['log']
number_groups_list_list = [[5]]
...
for xaxis in xaxis_list:
    for network_type, N, d, seed, space, degree_interval, number_groups_list in zip(network_list, N_list, d_list, seed_list, space_list, degree_interval_list, number_groups_list_list):
        for number_groups in number_groups_list:
            ...
            xs_resilience_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, number_groups, xaxis, space)
            pass
        ...
        xs_resilience_KNN_kcore_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, xaxis, regroup_criteria, space, degree_interval)
        xs_resilience_kcore_linear_expansion(network_type, N, d, seed, dynamics, xaxis, regroup)
        xs_resilience_kcore_degree_partition_linear_expansion(network_type, N, d, seed, dynamics, xaxis, space, degree_interval)
        pass
xaxis = 'k'
